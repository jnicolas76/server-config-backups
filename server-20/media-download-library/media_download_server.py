...
MOVIE_ROOT = Path(os.environ.get("MOVIE_ROOT", "/media/jnicolas/Expansion/Movies")).resolve()
...
def stable_asset_key(item: MovieItem) -> str:
    """Identity that survives extension, quality, and transcode filename changes."""
