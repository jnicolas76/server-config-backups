...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    .cast-person-card img,.cast-portrait-placeholder { width:108px; height:162px; display:grid; place-items:center; border-radius:14px; object-fit:cover; object-position:center top; padding:0; background:rgba(255,255,255,.10); border:2px solid rgba(255,255,255,.22); box-shadow:0 10px 24px rgba(0,0,0,.34); font-size:46px; }
