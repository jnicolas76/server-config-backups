...
:root{color-scheme:dark;--bg:#090a0d;--panel:#181a1e;--panel2:#23262b;--line:#393d43;--gold:#f5b400;--muted:#aeb4bc;--red:#e84b55;--green:#36d17c}*{box-sizing:border-box}body{margin:0;background:var(--bg);color:#fff;font:15px system-ui,Segoe UI,sans-serif}header{position:sticky;top:0;z-index:8;background:#111;border-bottom:1px solid #333;padding:13px 18px;padding-top:calc(13px + env(safe-area-inset-top));padding-left:calc(18px + env(safe-area-inset-left));padding-right:calc(18px + env(safe-area-inset-right))}.top{display:flex;flex-wrap:wrap;align-items:center;justify-content:space-between;gap:12px}.brand{font-size:24px;font-weight:900}.brand b{color:var(--gold)}button,a.btn{border:1px solid var(--line);background:var(--panel2);color:#fff;border-radius:8px;min-height:44px;padding:10px 14px;font-weight:750;text-decoration:none;cursor:pointer;display:inline-flex;align-items:center;justify-content:center}.primary{background:var(--gold);color:#111;border-color:var(--gold)}nav{display:flex;gap:6px;overflow:auto;-webkit-overflow-scrolling:touch;margin-top:12px}nav button{min-height:44px;white-space:nowrap}nav button.active{color:var(--gold);border-bottom-color:var(--gold)}main{padding:16px}.toolbar{display:flex;gap:8px;align-items:center;flex-wrap:wrap;margin-bottom:12px}.muted{color:var(--muted)}.guide-wrap{overflow:auto;-webkit-overflow-scrolling:touch;max-height:calc(100vh - 190px);max-height:calc(100dvh - 190px);border:1px solid var(--line);position:relative}.guide{min-width:1500px}.time-row,.channel-row{display:grid;grid-template-columns:155px 1fr}.time-row{position:sticky;top:0;z-index:5;background:#15171b}.channel-name{position:sticky;left:0;z-index:4;background:#17191d;border-right:1px solid var(--line);border-bottom:1px solid var(--line);padding:8px;display:flex;gap:8px;align-items:center}.channel-name img{width:38px;height:38px;object-fit:contain;background:#fff;border-radius:5px}.timeline{position:relative;height:70px;border-bottom:1px solid var(--line);background:repeating-linear-gradient(90deg,#16181c 0,#16181c calc(8.333% - 1px),#353940 calc(8.333% - 1px),#353940 8.333%)}.program{position:absolute;top:5px;height:59px;padding:7px;border:1px solid #484d55;background:#292c31;overflow:hidden;text-align:left;border-radius:4px;font-size:13px}.program.rec{border-color:var(--red);box-shadow:inset 3px 0 var(--red)}.program.now{background:#34383e}.time-labels{height:42px;position:relative}.time-labels span{position:absolute;padding:12px 5px;color:var(--muted)}.now-line{position:absolute;top:0;bottom:0;width:2px;background:var(--gold);z-index:3}.cards{display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:12px}.card{background:var(--panel);border:1px solid var(--line);border-radius:10px;padding:14px}.card h3{margin:0 0 6px}.status{font-weight:850;text-transform:uppercase;font-size:12px}.recording{color:var(--red)}.completed{color:var(--green)}.conflict,.failed,.missed{color:#ff747d}.tabsheet{display:none}.tabsheet.active{display:block}.modal{display:none;position:fixed;inset:0;background:#000b;z-index:20;align-items:center;justify-content:center;padding:18px;padding-top:calc(18px + env(safe-area-inset-top));padding-bottom:calc(18px + env(safe-area-inset-bottom))}.modal.open{display:flex}.dialog{width:min(560px,100%);max-height:calc(100vh - 36px);max-height:calc(100dvh - 36px);overflow:auto;-webkit-overflow-scrolling:touch;background:#1a1c20;border:1px solid #555;border-radius:12px;padding:20px}.dialog h2{margin-top:0}label{display:block;margin:10px 0 4px}input{width:100%;min-height:44px;padding:11px;background:#101216;color:#fff;border:1px solid #444;border-radius:7px;font-size:16px}.actions{display:flex;gap:8px;flex-wrap:wrap;margin-top:14px}@media(max-width:700px){.brand{font-size:19px}.guide-wrap{max-height:calc(100vh - 215px);max-height:calc(100dvh - 215px)}main{padding:10px}}
...
</style></head><body><header><div class="top"><div class="brand">CineMedia<b>Vault</b> Live TV & DVR</div><div><a class="btn" href="/">Home</a><a class="btn" href="/wall">Wall</a><a class="btn" href="/vchannels">Virtual Channels</a></div></div><nav id="nav"><button data-tab="guide">Guide</button><button data-tab="schedule">DVR Schedule</button><button data-tab="recordings">Recordings</button><button data-tab="series">Series</button><button data-tab="conflicts">Conflicts</button><button data-tab="settings">Settings</button></nav></header><main>
