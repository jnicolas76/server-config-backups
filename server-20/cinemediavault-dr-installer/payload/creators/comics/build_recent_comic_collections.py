...
COMICS = Path(os.environ.get("COMICS_ROOT", "/srv/cinevault/media/Comics"))  # CineMediaVault installer: parameterized
LIBRARY = Path(os.environ.get("CINEVAULT_COMIC_LIBRARY_ROOT", "/srv/cinevault/media/comic-library"))  # CineMediaVault installer: parameterized
COLLECTIONS = LIBRARY / "collections"
IMAGE_EXTENSIONS = {".gif", ".jpeg", ".jpg", ".png", ".webp"}
NOTIFIER = Path(os.environ.get("CINEVAULT_WEBEX_NOTIFIER", "/opt/cinemediavault/scripts/send_webex_notification.py"))  # CineMediaVault installer: parameterized


def load_gallery_module():
    path = Path(os.environ.get("CINEVAULT_COMIC_GALLERY_BASE", str(Path(__file__).resolve().parent / "build_new_comic_collections.py")))  # CineMediaVault installer: parameterized
